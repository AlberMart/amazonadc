    ...
    items: [
      {
        ...
        text: 'HEPA vacuums and rotary brushes through supplies, returns, and registers, then sanitizing when the inspection calls for it. See [air duct cleaning](/air-duct-cleaning).',
      },
      {
        title: 'Dryer Vent Cleaning',
        text: 'Woodbridge and Lake Ridge townhomes clog dryer runs fast. We clear the full length to the cap. Book [dryer vent cleaning](/dryer-vent-cleaning).',
      },
      {
  ...
  why: {
    ...
    items: [
      ...
      },
      {
        ...
        text: 'Townhomes and larger Gainesville houses are quoted before we start.',
      },
      {
        title: 'Corridor Housing We Know',
        text: 'Split-levels, HOA townhomes, and finished basements are a normal week for this crew.',
      },
      {
