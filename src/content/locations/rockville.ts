    ...
    items: [
      {
        ...
        text: 'HEPA negative pressure and rotary brushes through supplies, returns, and registers, plus sanitizing when the inspection finds biological growth. Photos are part of the job. See [air duct cleaning](/air-duct-cleaning).',
      },
      {
        title: 'Dryer Vent Cleaning',
        text: 'Townhome and condo dryer runs clog fast. We clear the full length to the exterior so you are not pushing lint, heat, and moisture back into the laundry. Book [dryer vent cleaning](/dryer-vent-cleaning).',
      },
      {
    ...
    items: [
      {
        ...
        text: 'Rockville is a short run from our Bethesda office. You are not waiting on a crew that started in another state.',
      },
      {
        title: 'Flat-Rate Pricing',
        text: 'No per-vent counting. Residential duct and dryer packages are quoted before we start.',
      },
      {
        title: 'Montgomery County Housing We Already Clean',
        text: 'The same technicians work Bethesda, Silver Spring, Gaithersburg, and Rockville. Basement trunks and townhome closets are normal, not extra.',
      },
      {
    ...
    groups: [
      {
        ...
        places: 'Rockville Town Center, Twinbrook, Hungerford, Lincoln Park, West End',
      },
      {
        title: 'King Farm & Fallsgrove',
        places: 'King Farm, Fallsgrove, King Farm Village, Research Boulevard corridor',
      },
      {
