...
export const washingtonDc: LocationContentSeed = {
  ...
  about: {
    ...
    highlights: [
      ...
      'Flat-rate air duct and dryer vent packages — no vent counting',
    ...
    items: [
      {
        ...
        text: 'Negative-pressure HEPA vacuums and rotary brushes on supplies, returns, and registers, then an eco-friendly sanitizing pass when the inspection calls for it. You keep the before-and-after photos. Book [air duct cleaning](/air-duct-cleaning) on its own or with a dryer vent.',
      },
      {
        title: 'Dryer Vent Cleaning',
        text: 'DC condos and English basements often have long, bent dryer runs that pack with lint. That is a fire risk and a humidity dump back into the laundry closet. We brush and vacuum the full length to the exterior cap. See [dryer vent cleaning](/dryer-vent-cleaning).',
      },
      {
  ...
  why: {
    ...
    items: [
      ...
      },
      {
        ...
        text: 'Row-house boots, tight condo closets, and rooftop packs are normal for this team — not a surprise add-on after we arrive.',
      },
      {
        title: '100% Satisfaction Guarantee',
        text: 'If you are not happy with the result, we come back. Payment is for work you can see in the photos.',
      },
    ],
  },
  communities: {
    ...
    groups: [
      {
        title: 'Northwest',
        places:
          'Georgetown, Dupont Circle, Adams Morgan, Cleveland Park, Woodley Park, Palisades, Friendship Heights, Tenleytown, Columbia Heights, Petworth, Logan Circle',
      },
      {
        title: 'Capitol Hill & Northeast',
        places: 'Capitol Hill, H Street, Brookland, Trinidad, NoMa, Union Market, Eckington',
      },
      {
        title: 'Southeast & the rivers',
        places: 'Navy Yard, Capitol Riverfront, Anacostia, Hill East, Barracks Row',
      },
      {
        title: 'Southwest',
        places: 'Southwest Waterfront, The Wharf, Buzzard Point',
      },
    ],
  },
  process: {
